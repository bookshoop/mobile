...
mixin _$SocialLoginData {
  ...
  LoginType get socialProvider => throw _privateConstructorUsedError;
...
class _$SocialLoginDataImpl implements _SocialLoginData {
  ...
  @override
  final LoginType socialProvider;
  @override
  final String socialId;

  @override
  String toString() {
    return 'SocialLoginData(profile: $profile, nickname: $nickname, phoneNumber: $phoneNumber, pushToken: $pushToken, birthday: $birthday, likeGenre: $likeGenre, accessRouteId: $accessRouteId, accessRoute: $accessRoute, socialProvider: $socialProvider, socialId: $socialId)';
  }
...
abstract class _SocialLoginData implements SocialLoginData {
  const factory _SocialLoginData(
      ...
      final int? accessRouteId,
      final int? accessRoute,
      required final LoginType socialProvider,
      required final String socialId}) = _$SocialLoginDataImpl;
