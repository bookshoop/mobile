...
class _CategoryRepository implements CategoryRepository {
  ...
  Future<List<BookCategory>> getAllCategory() async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<BookCategory>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => BookCategory.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
...
String _$categoryRepositoryHash() =>
    r'79f8567440461416ea4a3f8e45d1135c67318a38';
